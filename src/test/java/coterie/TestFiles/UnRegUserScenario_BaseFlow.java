...
public class UnRegUserScenario_BaseFlow {
	...
	@Test
	public void unRegUser() throws InterruptedException {
		...
		for (int j = 1; j < 4; j++) {
			summaryLabel = driver.findElement(By.xpath("//aside/div[2]/div[4]/div[2]/ul/li[" + j + "]/div[1]"));
			summaryPrice = driver.findElement(By.xpath("//aside/div[2]/div[4]/div[2]/ul/li[" + j + "]/div[2]"));
		...
		emailID = driver.findElement(By.xpath("//div/input[@id='checkout_email']"));
		emailID.sendKeys("test50145460@yopmail.com");
		firstName = driver.findElement(By.xpath("//div/input[contains(@id,'address_first_name')]"));
		firstName.sendKeys("John");
		lastName = driver.findElement(By.xpath("//div/input[contains(@id,'address_last_name')]"));
		lastName.sendKeys("Doe");
		address1 = driver.findElement(By.xpath("//div/input[contains(@id,'address_address1')]"));
		address1.sendKeys("123 Main Street");
		city = driver.findElement(By.xpath("//div/input[contains(@id,'address_city')]"));
		city.sendKeys("White Plains");
		province = driver.findElement(By.xpath("//div/select[contains(@id,'address_province')]"));
		Select state = new Select(province);
		state.selectByVisibleText("New York");

		zip = driver.findElement(By.xpath("//div/input[contains(@id,'address_zip')]"));
		zip.sendKeys("10601");
		phone = driver.findElement(By.xpath("//div/input[contains(@id,'address_phone')]"));
		phone.sendKeys("5465654654");
		...
		for (int a = 1; a < 4; a++) {
			label = driver.findElement(By.xpath("//div/table[contains(@class,'total-line')]/tbody/tr[" + a + "]/th"))
					.getText();
			cost = driver
					.findElement(By.xpath("//div/table[contains(@class,'total-line')]/tbody/tr[" + a + "]/td/span"))
					.getText();
			System.out.println(label + " : " + cost);

		}

		String totalLabel = driver.findElement(By.xpath("//div/table[contains(@class,'total-line')]/tfoot/tr/th"))
				.getText();
		String totalCost = driver.findElement(By.xpath("//div/table[contains(@class,'total-line')]/tfoot/tr/td"))
				.getText();
