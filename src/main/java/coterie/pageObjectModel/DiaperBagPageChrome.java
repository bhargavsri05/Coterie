...
public class DiaperBagPageChrome extends AbstractComponent {
	WebDriver driver;

	public DiaperBagPageChrome(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void titleVal(String actualPageTitle, String expectedPageTitle) {
		...
		if (actualPageTitle.equalsIgnoreCase(expectedPageTitle)) {
			System.out.println("Diaper Bag Page, Actual Title Matches with the Expected Title");
		} else {
			System.out.println("Diaper Bag Page, Actual Title doesn't Matches with the Expected Title");
		}
	}
	...
	public void diaperBag_Submit() throws Exception {
